...
export function NewsSection() {
  ...
  const featured = newsletterPosts[0];
  const archive = newsletterPosts.slice(1, 4);
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                <div className="flex items-center gap-2 text-[var(--etg-red)] mb-5">
                  ...
                  <span className="section-label" style={{ fontSize: "0.75rem" }}>
                    {formatPublishedDate(featured.publishedAt)} • Latest Issue
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    <Link href={`/newsletters/${featured.slug}`}>
                      READ NEWSLETTER
            ...
            {archive.map((newsletter, index) => (
              ...
              >
                ...
                <div className="p-5 bg-[var(--surface-2)]">
                  ...
                  >
                    <Link href={`/newsletters/${newsletter.slug}`}>READ</Link>
                  </Button>
                </div>
              </Card>
            ))}
